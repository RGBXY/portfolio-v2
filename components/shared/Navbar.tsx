...
const Navbar = () => {
  return (
    <div className="fixed z-40 h-12.5 border-b border-b-secondary-gray text-sm text-secondary-gray bg-primary-black/95 backdrop-blur-md w-full flex items-center justify-between px-10">
