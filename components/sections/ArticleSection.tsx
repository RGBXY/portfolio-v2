        ...
        <div className="w-full relative lg:pt-16 lg:space-y-30 space-y-10">
          ...
          <div className="space-y-30">
            <div className="lg:ps-10 group">
              ...
              <div className="mt-4 space-y-1.5 border-b border-gray-500 lg:pb-8 pb-6">
                <h1 className="lg:text-40 md:text-3xl text-2xl lg:leading-16 md:leading-9 leading-7">How to Work and Collaborate with Me</h1>
