  ...
  return (
    <section ref={heroRef} className="bg-black h-[100svh] w-full flex flex-col text-white">
      <div className="h-full w-full">
        <FlickeringGrid className="fixed inset-0 z-0 w-screen h-full [mask-image:radial-gradient(100%_circle_at_center,white,transparent)]" squareSize={2} gridGap={15} color="#eee" maxOpacity={0.5} flickerChance={0.1} />
