...
const ArticleCard = ({ data }: ArticleCardProps) => {
  return (
    <div className="border-b border-gray-500 group lg:pb-8 pb-6 group flex items-center justify-between gap-6 lg:gap-12">
      <div className="flex md:flex-row flex-col md:items-center items-start gap-6 lg:gap-12">
        ...
        <div className="flex-1 lg:space-y-3 space-y-2 ">
          <h1 className="lg:text-40 md:text-3xl text-2xl lg:leading-14 md:leading-9 leading-7">{data.title}</h1>
